              ...
              parts: [
                {
                  text:
                    ...
                    "Not every labeled box on the drawing is an enclosed room with its own walls - an area like 'Damaged Items', 'RTO / Exceptional Shipments', 'Returns', or an inward/receiving buffer is usually just an open floor area marked off with a label or a dashed line, not a walled room. Use \"returns\" for a returns/RTO area, \"exception\" for a damaged/missort/exception-handling area, and \"receiving\" for an inward/unload buffer - do NOT force one of these into \"office\"/\"store\"/\"security\" etc just because those are more familiar; picking the wrong type makes it render as a walled room when it should be open floor. " +
                    ...
                    '  "rooms": [ { "name": string, "type": "office"|"security"|"conference"|"medical"|"store"|"ups"|"bathroom"|"inboundStage"|"outboundLane"|"charging"|"returns"|"exception"|"receiving"|"battery", "x": number, "y": number, "w": number, "h": number } ],\n' +
